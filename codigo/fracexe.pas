...
{ Programa para graficar Sistemas Iterados de Funciones en Rý usando el
  ...
  Esta unidad contiene en realidad todo el codigo de graficacion y
  manipulacion de los fractales.      }
...
PROCEDURE FRACTALES;   { ESTE ES TODO EL PROGRAMA FRACTALES LINEALES 1.2 }
...
Procedure ParamDefecto;
  ...
  Procedure ConfigDir;
    Var
       ...
       ErrorEnDisco    :  Word;
    Begin
      Assign(ArchivoConfig,'FracLin.INI');
      {$I-}
      Reset(ArchivoConfig);
      {$I+}
